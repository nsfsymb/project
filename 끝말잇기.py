...
HANBANG_DICT = {
    ...
    "개": [
        "개두릅", "개를돌봐줘", "개릭클럽", "개미기는느낌", "개발도상국이주가된교섭그룹", 
        "개발시스템처리기모듈", "개밥그릇", "개방사용자그룹", "개부럽", "개스킷", 
        "개심매듭", "개울녘", "개인모듈", "개입중단모듈", "개입중단패킷", 
        "개노릇", "개돌상눔", "개드릅", "개드릎", "개비눔", 
        "개시그릇", "개욹", "개잡눔", "개좃", "개지럴", 
        "개녘", "개수그릇"
    ],
    "객": [
    ...
    "거": [
        "거리낌", "거리의모듈", "거먕", "거북이수영클럽", "거뿐", 
        "거뿟", "거욷", "거짓부렁", "거렁", "거븍", 
        "거윽", "거줏부렁", "거즛부렁", "거짓부렝", "거큼", 
        "거킁", "거믜", "거붑"
    ],
    "기": ["기쁨", "기름", "기륨"],
    "나": ["나트륨", "나이오비움"],
